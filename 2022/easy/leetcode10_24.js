...
// return string
// examples
// pseudo code given a string create a variable as a new set, then iterate over the array checking each character, if the character is in the set return that character otherwise add it to the set
